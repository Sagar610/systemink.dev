...
export const COMMENTS_BY_POST: Record<string, CommentPublic[]> = {
  ...
  'post-eval-rag': [
    comment(
      'c-eval-1',
      'aisharahman',
      'The holdout warning should be on the wall. We fooled ourselves on a classifier the same way. Different stack, same vanity.',
      '2023-07-21T10:18:00.000Z',
      17,
    ),
    comment(
      'c-eval-2',
